...
def mostrar_menu():
    ...
    unidades = {
        '1': 'Semana 1/Hilos.py',
        '2': 'Semana 2/Ejemplos de Técnicas de Programación.py',
        '3': 'Semana 3/POO - Clima.py',
        '4': 'Semana 3/Programacion tradicional - Clima.py',
        '5': 'Semana 4 - EjemplosMundoReal_POO/Contactos.py',
        '6': 'Semana 4 - EjemplosMundoReal_POO/SimuladorCajero.py',
        '7': 'Semana 5/AreaFigurasGeometricas.py',
        '8': 'Semana 6/POO - Auto.py',
        '9': 'Semana 7 - Constructores y Destructores/Constructores y Destructores.py',
    }
    ...
    while True:
        ...
        if eleccion_unidad == '0':
            ...
            # Mostrar el código antes de ejecutarlo
